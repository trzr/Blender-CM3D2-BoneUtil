...
dic = {
    "en_US": {
        ...
        ("*", "butl.vgroups.ImportLabel"): "From BoneData",
    ...
    "ja_JP": {
        ...
        ("*", "butl.PushSaveButton"): "ここの設定は「ユーザー設定の保存」ボタンを押すまで保存されません",
        ...
        ("*", "butl.vgroups.VertexGroupCreated"): "ボーンから頂点グループをサ宇正しました。作成数=%d",
