...
dic = {
    "en_US": {
        ...
        ("*", "butl.PushSaveButton"): "Please push button \"Save Preferences\" for save option",
        ...
        ("*", "butl.EnumDescAll"): "all bones",
        ("*", "butl.EnumDescSelected"): "selected bones only",
        ("*", "butl.EnumDescDescendant"): "selected and descendants bones",
        ("*", "butl.EnumDescLocalBoneData"): "LocalBoneData on Custom Property",
        ("*", "butl.Target"): "Target bones",
        ("*", "butl.ImportTarget:"): "ImportTarget:",
        ("*", "butl.ScaleDesc"): "specify scale value",
        ("*", "butl.VertexGroup"): "Vertex Groups",
        ("*", "butl.VertexGroup:"): "Vertex Groups:",
        ("*", "butl.DataSource:"): "Data Source:",
        ("*", "butl.FilterConfig:"): "Filter Config:",
        ("*", "butl.feature.ChangeBoneType"): "Change bone-type feature",
        ("*", "butl.feature.ChangeBoneTypeDesc"): "this feature change bone-types as a whole",
        ("*", "butl.feature.BsImporter"): "ShapeKey operation feature",
        ("*", "butl.feature.BsImporterDesc"): "this feature change shape-key values by blendset",
        ("*", "butl.feature.Vertexgroups"): "Vertex group feature",
        ("*", "butl.feature.VertexgroupsDesc"): "this feature for vertex group",
        ...
        ("*", "butl.bdimport.ImportCompleted"): "Import completed",
        ...
        ("*", "butl.bdimport.Model2001Desc"): "model version 2001 (available only for com3d2)",
        ("*", "butl.bdimport.Model1000Desc"): "model version 1000 (available for cm3d2/com3d2)",
        ...
        ("*", "butl.vgroups.ImportLabel"): "Import From BoneData",
        ("*", "butl.vgroups.ImportDesc"): "Create Vertex groups from BoneData",
        ("*", "butl.vgroups.SkipNub"): "skip nub-bones",
        ("*", "butl.vgroups.SkipNubDesc"): "skip nub-bones",
        ("*", "butl.vgroups.SkipShapeKeyName"): "skip bone has shapekey-name",
        ("*", "butl.vgroups.SkipShapeKeyNameDesc"): "skip bone has shpekey-name",
        ("*", "butl.vgroups.NotFoundSourceBone"): "not found data-source(BoneData)",
        ("*", "butl.vgroups.VertexGroupCreated"): "Vertex group was created from bone data. num=%d",
        ("*", "butl.vgroups.VertexGroupAlreadyExist"): "Vertex group has already been created.",
        ("*", "Select"): "select",
    ...
    "ja_JP": {
        ...
        ("*", "butl.PushSaveButton"): "ここの設定は「設定を保存」ボタンを押すまで保存されません",
        ("*", "butl.BaseBoneName"): "BaseBone名",
        ("*", "butl.RenameBone"): "Armature上のBoneリネーム",
        ("*", "butl.EnumAll"): "全ボーン",
        ("*", "butl.EnumSelected"): "選択ボーンのみ",
        ("*", "butl.EnumDescendant"): "選択ボーン+子孫ボーン",
        ("*", "butl.EnumDescAll"): "すべてのボーン",
        ("*", "butl.EnumDescSelected"): "選択されたボーンのみ",
        ("*", "butl.EnumDescDescendant"): "選択ボーン+子孫ボーン",
        ("*", "butl.EnumDescLocalBoneData"): "カスタムプロパティ上のLocalBoneData",
        ("*", "butl.Target"): "ターゲット:",
        ("*", "butl.ImportTarget:"): "取込み対象:",
        ("*", "butl.ScaleDesc"): "modelインポート時の拡大率を指定してください",
        ("*", "butl.VertexGroup"): "頂点グループ",
        ("*", "butl.VertexGroup:"): "頂点グループ:",
        ("*", "butl.DataSource:"): "データソース:",
        ("*", "butl.FilterConfig:"): "フィルタ設定:",
        ("*", "butl.feature.ChangeBoneType"): "揺れボーンのタイプ変更",
        ("*", "butl.feature.ChangeBoneTypeDesc"): "揺れボーンのタイプを一括で変更する機能",
        ("*", "butl.feature.BsImporter"): "シェイプキー値変更",
        ("*", "butl.feature.BsImporterDesc"): "シェイプキーの値セットを一括変更する機能",
        ("*", "butl.feature.Vertexgroups"): "頂点グループ関連機能",
        ("*", "butl.feature.VertexgroupsDesc"): "頂点グループ関連の機能追加",
        ...
        ("*", "butl.bdimport.Model2001Desc"): "COM3D2専用のモデルバージョン",
        ("*", "butl.bdimport.Model1000Desc"): "CM3D2/COM3D2で利用可能なバージョン",
        ...
        ("*", "butl.vgroups.ImportLabel"): "ボーン情報から取り込み",
        ("*", "butl.vgroups.ImportDesc"): "ボーン情報から頂点グループを作成します",
        ("*", "butl.vgroups.SkipNub"): "nubボーン スキップ",
        ("*", "butl.vgroups.SkipNubDesc"): "末端ボーンをスキップする",
        ("*", "butl.vgroups.SkipShapeKeyName"): "シェイプキーと同名をスキップ",
        ("*", "butl.vgroups.SkipShapeKeyNameDesc"): "シェイプキーと同名のボーンをスキップする",
        ("*", "butl.vgroups.NotFoundSourceBone"): "抽出元のボーン情報がありません。中断します",
        ("*", "butl.vgroups.VertexGroupCreated"): "ボーンから頂点グループを作成しました。作成数=%d",
        ("*", "butl.vgroups.VertexGroupAlreadyExist"): "頂点グループはすべて作成済みです",
        ("*", "Select"): "選択",
...
def get_dic():
    default_trans = dic.get('en_US')
    if default_trans:
        for locale in bpy.app.translations.locales:
            dic.setdefault(locale, default_trans)
    return dic